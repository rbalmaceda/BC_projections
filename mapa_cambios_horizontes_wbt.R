...
for (k in 1:3) {
  ...
  if( k==1){methods=substr(x = list,stop=nchar(list),start = 19)}
...
####Agrego el raw##################
# raw_serie_list=wbt_raw_serie_list
names(wbt_raw_serie_list)=c("wbt_raw_train","wbt_raw_train_esc", "wbt_raw_fut", "wbt_raw_fut_esc")
pp_all <-wbt_raw_serie_list[[paste0(var,"_raw_fut_esc")]]
...
wbt_df_clim_all_lejano_mean=rbind(wbt_mean_serie_list_lejano_ETA,wbt_mean_serie_list_lejano_RegCM,wbt_mean_serie_list_lejano_REMO)
wbt_df_clim_all_mediano_mean=rbind(wbt_mean_serie_list_mediano_ETA,wbt_mean_serie_list_mediano_RegCM,wbt_mean_serie_list_mediano_REMO)
save(wbt_df_clim_all_lejano_mean,file="wbt_df_clim_all_lejano_mean.rda")
save(wbt_df_clim_all_mediano_mean,file="wbt_df_clim_all_mediano_mean.rda")
