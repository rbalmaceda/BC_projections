...
tasmax_df_clim_all_lejano_mean=rbind(tasmax_mean_serie_list_lejano_ETA,tasmax_mean_serie_list_lejano_RegCM,tasmax_mean_serie_list_lejano_REMO)
tasmax_df_clim_all_mediano_mean=rbind(tasmax_mean_serie_list_mediano_ETA,tasmax_mean_serie_list_mediano_RegCM,tasmax_mean_serie_list_mediano_REMO)
save(tasmax_df_clim_all_lejano_mean,file="tasmax_df_clim_all_lejano_mean.rda")
save(tasmax_df_clim_all_mediano_mean,file="tasmax_df_clim_all_mediano_mean.rda")
...
ggsave(gg,filename=paste0(var,"_fut_mediano_",rcms[k],"2.png"),device="png",dpi=300,width=7,height = 6,scale=0.7)
...
ggsave(gg,filename=paste0(var,"_fut_lejano_",rcms[k],"2.png"),device="png",dpi=300,width=7,height = 6,scale=0.7)
...
gg<- ggplot(df_diff) + geom_contour_fill(aes(x=Lon,y=Lat,z=Dif),bins = 50)+
  ...
  scale_y_continuous(breaks = seq(-40,-18, by = 10)) +scale +my_theme+ 
  labs(main='Tx',x = "Longitude",y = "Latitude") +
 guides(fill=guide_legend(reverse = F,title ="degC",ncol =12,nrow=1,label.position = "bottom"))
